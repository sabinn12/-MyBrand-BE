...
blogsRoutes.post('/', multer_1.fileUpload.single('image'), multer_1.customFileFilter, auth_1.default.tokenValidation, blogscontroller_1.default.create_blogs);
blogsRoutes.get('/', blogscontroller_1.default.getAllBlogs);
blogsRoutes.get('/:id', blogscontroller_1.default.getSingleBlog);
blogsRoutes.patch('/:id', multer_1.fileUpload.single('image'), multer_1.customFileFilter, auth_1.default.tokenValidation, blogscontroller_1.default.updatedBlogs);
