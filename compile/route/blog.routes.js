...
blogsRoutes.post('/', jwt_1.default.tokenValidation, multer_1.fileUpload.single('image'), multer_1.customFileFilter, blogscontroller_1.default.create_blogs);
blogsRoutes.get('/', blogscontroller_1.default.getAllBlogs);
blogsRoutes.get('/:id', blogscontroller_1.default.getSingleBlog);
blogsRoutes.put('/:id', jwt_1.default.tokenValidation, multer_1.fileUpload.single('image'), multer_1.customFileFilter, blogscontroller_1.default.updatedBlogs);
